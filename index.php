...
<html lang="es">
    ...
    <head>
        ...
        <meta charset="utf-8">
        <title>Acceso | DylanDev - Mesa de Partes</title>
                                ...
                                <div class="d-flex flex-column h-100">
                                    <div class="mb-4 mb-md-5 text-center">
                                        <a href="index-1.html" class="d-block auth-logo">
                                            <img src="assets/picture/logo-sm-1.svg" alt="" height="28"> <span class="logo-txt">DylanDev</span>
                                        </a>
                                    </div>
                                    <div class="auth-content my-auto">
                                        ...
                                        <form class="custom-form mt-4 pt-2">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="usu_correo" placeholder="ingrese correo electrónico">
                                            </div>
                                            <div class="mb-3">
                                    ...
                                    <div class="mt-4 mt-md-5 text-center">
                                        <p class="mb-0">© <script>document.write(new Date().getFullYear())</script> DylanDev <i class="mdi mdi-heart text-danger"></i></p>
                                    </div>
                                </div>
                            </div>
                        </div>
